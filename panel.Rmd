...
results$tests
```
```{r int_ufmr_conflict_incidence, fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%", fig.show = 'hold'}
IntPlot(fit = results$ests$fe$m3$fit, eff_var = "lag_conflict_internal", title = "Effect of Internal Conflict (FE)")
IntPlot(fit = results$ests$fegls$m3$fit, eff_var = "lag_conflict_internal", title = "Effect of Internal Conflict (FEGLS)")
IntPlot(fit = results$ests$fe$m4$fit, eff_var = "lag_conflict_internal", title = "Effect of Internal Conflict (FE)")
IntPlot(fit = results$ests$fegls$m4$fit, eff_var = "lag_conflict_internal", title = "Effect of Internal Conflict (FEGLS)")
...
results$tests
```
```{r int_ufmr_war_incidence, fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%", fig.show = 'hold'}
IntPlot(fit = results$ests$fe$m3$fit, eff_var = "lag_war_internal", title = "Effect of Internal War (FE)")
IntPlot(fit = results$ests$fegls$m3$fit, eff_var = "lag_war_internal", title = "Effect of Internal War (FEGLS)")
IntPlot(fit = results$ests$fe$m4$fit, eff_var = "lag_war_internal", title = "Effect of Internal Conflict (FE)")
IntPlot(fit = results$ests$fegls$m4$fit, eff_var = "lag_war_internal", title = "Effect of Internal Conflict (FEGLS)")
...
results$tests
```
```{r int_ufmr_conflict_deaths, fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%", fig.show = 'hold'}
IntPlot(fit = results$ests$fe$m3$fit, eff_var = "lag_lg_deaths_all_int_rate", title = "Effect of Conflict Deaths (FE)")
IntPlot(fit = results$ests$fegls$m3$fit, eff_var = "lag_lg_deaths_all_int_rate", title = "Effect of Conflict Deaths (FEGLS)")
IntPlot(fit = results$ests$fe$m4$fit, eff_var = "lag_lg_deaths_all_int_rate", title = "Effect of Internal Conflict Deaths (FE)")
IntPlot(fit = results$ests$fegls$m4$fit, eff_var = "lag_lg_deaths_all_int_rate", title = "Effect of Internal Conflict Deaths (FEGLS)")
...
results$tests
```
```{r int_ufmr_conflict_deaths_civ, fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%", fig.show = 'hold'}
IntPlot(fit = results$ests$fe$m3$fit, eff_var = "lag_lg_deaths_civilians_int_rate", title = "Effect of Civilian Conflict Deaths (FE)")
IntPlot(fit = results$ests$fegls$m3$fit, eff_var = "lag_lg_deaths_civilians_int_rate", title = "Effect of Civilian Conflict Deaths (FEGLS)")
IntPlot(fit = results$ests$fe$m4$fit, eff_var = "lag_lg_deaths_civilians_int_rate", title = "Effect of Conflict Civilian Deaths (FE)")
IntPlot(fit = results$ests$fegls$m4$fit, eff_var = "lag_lg_deaths_civilians_int_rate", title = "Effect of Conflict Civilian Deaths (FEGLS)")
...
results$tests
```
```{r int_ufmr_osv_incidence, fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%", fig.show = 'hold'}
IntPlot(fit = results$ests$fe$m3$fit, eff_var = "lag_conflict_one_sided", title = "Effect of One-Sided Violence (FE)")
IntPlot(fit = results$ests$fegls$m3$fit, eff_var = "lag_conflict_one_sided", title = "Effect of One-Sided Violence (FEGLS)")
IntPlot(fit = results$ests$fe$m4$fit, eff_var = "lag_conflict_one_sided", title = "Effect of One-sided Violence (FE)")
IntPlot(fit = results$ests$fegls$m4$fit, eff_var = "lag_conflict_one_sided", title = "Effect of One-sided Violence (FEGLS)")
...
results$tests
```
```{r int_ufmr_osv_deaths, fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%", fig.show = 'hold'}
IntPlot(fit = results$ests$fe$m3$fit, eff_var = "lag_lg_deaths_civilians_osv_rate", title = "Effect of OSV Deaths (FE)")
IntPlot(fit = results$ests$fegls$m3$fit, eff_var = "lag_lg_deaths_civilians_osv_rate", title = "Effect of OSV Deaths (FEGLS)")
IntPlot(fit = results$ests$fe$m4$fit, eff_var = "lag_lg_deaths_civilians_osv_rate", title = "Effect of OSV Deaths (FE)")
IntPlot(fit = results$ests$fegls$m4$fit, eff_var = "lag_lg_deaths_civilians_osv_rate", title = "Effect of OSV Deaths (FEGLS)")
...
results$tests
```
```{r int_ufmr_nsc_incidence, fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%", fig.show = 'hold'}
IntPlot(fit = results$ests$fe$m3$fit, eff_var = "lag_conflict_non_state", title = "Effect of Non-state Conflict (FE)")
IntPlot(fit = results$ests$fegls$m3$fit, eff_var = "lag_conflict_non_state", title = "Effect of Non-state Conflict (FEGLS)")
IntPlot(fit = results$ests$fe$m4$fit, eff_var = "lag_conflict_non_state", title = "Effect of Non-state Conflict (FE)")
IntPlot(fit = results$ests$fegls$m4$fit, eff_var = "lag_conflict_non_state", title = "Effect of Non-state Conflict (FEGLS)")
...
results$tests
```
```{r int_ufmr_nsc_deaths, fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%", fig.show = 'hold'}
IntPlot(fit = results$ests$fe$m3$fit, eff_var = "lag_lg_deaths_all_nsc_rate", title = "Effect of Non-state Conflict Deaths (FE)")
IntPlot(fit = results$ests$fegls$m3$fit, eff_var = "lag_lg_deaths_all_nsc_rate", title = "Effect of Non-state Conflict Deaths (FEGLS)")
IntPlot(fit = results$ests$fe$m4$fit, eff_var = "lag_lg_deaths_all_nsc_rate", title = "Effect of Non-state Conflict Deaths (FE)")
IntPlot(fit = results$ests$fegls$m4$fit, eff_var = "lag_lg_deaths_all_nsc_rate", title = "Effect of Non-state Conflict Deaths (FEGLS)")
...
results$tests
```
```{r int_ufmr_nsc_deaths_civ, fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%", fig.show = 'hold'}
IntPlot(fit = results$ests$fe$m3$fit, eff_var = "lag_lg_deaths_civilians_nsc_rate", title = "Effect of Non-state Conflict Civilian Deaths (FE)")
IntPlot(fit = results$ests$fegls$m3$fit, eff_var = "lag_lg_deaths_civilians_nsc_rate", title = "Effect of Non-state Conflict Civilian Deaths (FEGLS)")
IntPlot(fit = results$ests$fe$m4$fit, eff_var = "lag_lg_deaths_civilians_nsc_rate", title = "Effect of Non-state Conflict Civilian Deaths (FE)")
IntPlot(fit = results$ests$fegls$m4$fit, eff_var = "lag_lg_deaths_civilians_nsc_rate", title = "Effect of Non-state Conflict Civilian Deaths (FEGLS)")
...
results$tests
```
```{r int_ufmr_homicides, fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%", fig.show = 'hold'}
IntPlot(fit = results$ests$fe$m3$fit, eff_var = "lag_lg_hom_odcwho_rate", title = "Effect of Homicides (FE)")
IntPlot(fit = results$ests$fegls$m3$fit, eff_var = "lag_lg_hom_odcwho_rate", title = "Effect of Homicides (FEGLS)")
IntPlot(fit = results$ests$fe$m4$fit, eff_var = "lag_lg_hom_odcwho_rate", title = "Effect of Homicides (FE)")
IntPlot(fit = results$ests$fegls$m4$fit, eff_var = "lag_lg_hom_odcwho_rate", title = "Effect of Homicides (FEGLS)")
...
results$tests
```
```{r int_ufmr_lpi, fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%", fig.show = 'hold'}
IntPlot(fit = results$ests$fe$m3$fit, eff_var = "lag_latentmean_fariss", title = "Effect of Latent Physical Integrity (FE)")
IntPlot(fit = results$ests$fegls$m3$fit, eff_var = "lag_latentmean_fariss", title = "Effect of Latent Physical Integrity (FEGLS)")
IntPlot(fit = results$ests$fe$m4$fit, eff_var = "lag_latentmean_fariss", title = "Effect of Latent Physical Integrity (FE)")
IntPlot(fit = results$ests$fegls$m4$fit, eff_var = "lag_latentmean_fariss", title = "Effect of Latent Physical Integrity (FEGLS)")
...
results$tests
```
```{r int_ufmr_killings, fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%", fig.show = 'hold'}
IntPlot(fit = results$ests$fe$m3$fit, eff_var = "lag_v2clkill", title = "Effect of Extra-Judicial Killings (FE)")
IntPlot(fit = results$ests$fegls$m3$fit, eff_var = "lag_v2clkill", title = "Effect of Extra-Judicial Killings (FEGLS)")
IntPlot(fit = results$ests$fe$m4$fit, eff_var = "lag_v2clkill", title = "Effect of Extra-Judicial Killings (FE)")
IntPlot(fit = results$ests$fegls$m4$fit, eff_var = "lag_v2clkill", title = "Effect of Extra-Judicial Killings (FEGLS)")
...
results$tests
```
```{r int_ufmr_torture, fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%", fig.show = 'hold'}
IntPlot(fit = results$ests$fe$m3$fit, eff_var = "lag_v2cltort", title = "Effect of State Torture (FE)")
IntPlot(fit = results$ests$fegls$m3$fit, eff_var = "lag_v2cltort", title = "Effect of State Torture (FEGLS)")
IntPlot(fit = results$ests$fe$m4$fit, eff_var = "lag_v2cltort", title = "Effect of State Torture (FE)")
IntPlot(fit = results$ests$fegls$m4$fit, eff_var = "lag_v2cltort", title = "Effect of State Torture (FEGLS)")
...
results$tests
```
```{r int_daly_conflict_incidence, fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%", fig.show = 'hold'}
IntPlot(fit = results$ests$fe$m3$fit, eff_var = "lag_conflict_internal", title = "Effect of Internal Conflict (FE)")
IntPlot(fit = results$ests$fegls$m3$fit, eff_var = "lag_conflict_internal", title = "Effect of Internal Conflict (FEGLS)")
IntPlot(fit = results$ests$fe$m4$fit, eff_var = "lag_conflict_internal", title = "Effect of Internal Conflict (FE)")
IntPlot(fit = results$ests$fegls$m4$fit, eff_var = "lag_conflict_internal", title = "Effect of Internal Conflict (FEGLS)")
...
results$tests
```
```{r int_daly_war_incidence, fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%", fig.show = 'hold'}
IntPlot(fit = results$ests$fe$m3$fit, eff_var = "lag_war_internal", title = "Effect of Internal War (FE)")
IntPlot(fit = results$ests$fegls$m3$fit, eff_var = "lag_war_internal", title = "Effect of Internal War (FEGLS)")
IntPlot(fit = results$ests$fe$m4$fit, eff_var = "lag_war_internal", title = "Effect of Internal Conflict (FE)")
IntPlot(fit = results$ests$fegls$m4$fit, eff_var = "lag_war_internal", title = "Effect of Internal Conflict (FEGLS)")
...
results$tests
```
```{r int_daly_conflict_deaths, fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%", fig.show = 'hold'}
IntPlot(fit = results$ests$fe$m3$fit, eff_var = "lag_lg_deaths_all_int_rate", title = "Effect of Conflict Deaths (FE)")
IntPlot(fit = results$ests$fegls$m3$fit, eff_var = "lag_lg_deaths_all_int_rate", title = "Effect of Conflict Deaths (FEGLS)")
IntPlot(fit = results$ests$fe$m4$fit, eff_var = "lag_lg_deaths_all_int_rate", title = "Effect of Internal Conflict Deaths (FE)")
IntPlot(fit = results$ests$fegls$m4$fit, eff_var = "lag_lg_deaths_all_int_rate", title = "Effect of Internal Conflict Deaths (FEGLS)")
...
results$tests
```
```{r int_daly_conflict_deaths_civ, fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%", fig.show = 'hold'}
IntPlot(fit = results$ests$fe$m3$fit, eff_var = "lag_lg_deaths_civilians_int_rate", title = "Effect of Civilian Conflict Deaths (FE)")
IntPlot(fit = results$ests$fegls$m3$fit, eff_var = "lag_lg_deaths_civilians_int_rate", title = "Effect of Civilian Conflict Deaths (FEGLS)")
IntPlot(fit = results$ests$fe$m4$fit, eff_var = "lag_lg_deaths_civilians_int_rate", title = "Effect of Conflict Civilian Deaths (FE)")
IntPlot(fit = results$ests$fegls$m4$fit, eff_var = "lag_lg_deaths_civilians_int_rate", title = "Effect of Conflict Civilian Deaths (FEGLS)")
...
results$tests
```
```{r int_daly_osv_incidence, fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%", fig.show = 'hold'}
IntPlot(fit = results$ests$fe$m3$fit, eff_var = "lag_conflict_one_sided", title = "Effect of One-Sided Violence (FE)")
IntPlot(fit = results$ests$fegls$m3$fit, eff_var = "lag_conflict_one_sided", title = "Effect of One-Sided Violence (FEGLS)")
IntPlot(fit = results$ests$fe$m4$fit, eff_var = "lag_conflict_one_sided", title = "Effect of One-sided Violence (FE)")
IntPlot(fit = results$ests$fegls$m4$fit, eff_var = "lag_conflict_one_sided", title = "Effect of One-sided Violence (FEGLS)")
...
results$tests
```
```{r int_daly_osv_deaths, fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%", fig.show = 'hold'}
IntPlot(fit = results$ests$fe$m3$fit, eff_var = "lag_lg_deaths_civilians_osv_rate", title = "Effect of OSV Deaths (FE)")
IntPlot(fit = results$ests$fegls$m3$fit, eff_var = "lag_lg_deaths_civilians_osv_rate", title = "Effect of OSV Deaths (FEGLS)")
IntPlot(fit = results$ests$fe$m4$fit, eff_var = "lag_lg_deaths_civilians_osv_rate", title = "Effect of OSV Deaths (FE)")
IntPlot(fit = results$ests$fegls$m4$fit, eff_var = "lag_lg_deaths_civilians_osv_rate", title = "Effect of OSV Deaths (FEGLS)")
...
results$tests
```
```{r int_daly_nsc_incidence, fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%", fig.show = 'hold'}
IntPlot(fit = results$ests$fe$m3$fit, eff_var = "lag_conflict_non_state", title = "Effect of Non-state Conflict (FE)")
IntPlot(fit = results$ests$fegls$m3$fit, eff_var = "lag_conflict_non_state", title = "Effect of Non-state Conflict (FEGLS)")
IntPlot(fit = results$ests$fe$m4$fit, eff_var = "lag_conflict_non_state", title = "Effect of Non-state Conflict (FE)")
IntPlot(fit = results$ests$fegls$m4$fit, eff_var = "lag_conflict_non_state", title = "Effect of Non-state Conflict (FEGLS)")
...
results$tests
```
```{r int_daly_nsc_deaths, fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%", fig.show = 'hold'}
IntPlot(fit = results$ests$fe$m3$fit, eff_var = "lag_lg_deaths_all_nsc_rate", title = "Effect of Non-state Conflict Deaths (FE)")
IntPlot(fit = results$ests$fegls$m3$fit, eff_var = "lag_lg_deaths_all_nsc_rate", title = "Effect of Non-state Conflict Deaths (FEGLS)")
IntPlot(fit = results$ests$fe$m4$fit, eff_var = "lag_lg_deaths_all_nsc_rate", title = "Effect of Non-state Conflict Deaths (FE)")
IntPlot(fit = results$ests$fegls$m4$fit, eff_var = "lag_lg_deaths_all_nsc_rate", title = "Effect of Non-state Conflict Deaths (FEGLS)")
...
results$tests
```
```{r int_daly_nsc_deaths_civ, fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%", fig.show = 'hold'}
IntPlot(fit = results$ests$fe$m3$fit, eff_var = "lag_lg_deaths_civilians_nsc_rate", title = "Effect of Non-state Conflict Civilian Deaths (FE)")
IntPlot(fit = results$ests$fegls$m3$fit, eff_var = "lag_lg_deaths_civilians_nsc_rate", title = "Effect of Non-state Conflict Civilian Deaths (FEGLS)")
IntPlot(fit = results$ests$fe$m4$fit, eff_var = "lag_lg_deaths_civilians_nsc_rate", title = "Effect of Non-state Conflict Civilian Deaths (FE)")
IntPlot(fit = results$ests$fegls$m4$fit, eff_var = "lag_lg_deaths_civilians_nsc_rate", title = "Effect of Non-state Conflict Civilian Deaths (FEGLS)")
...
results$tests
```
```{r int_daly_homicides, fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%", fig.show = 'hold'}
IntPlot(fit = results$ests$fe$m3$fit, eff_var = "lag_lg_hom_odcwho_rate", title = "Effect of Homicides (FE)")
IntPlot(fit = results$ests$fegls$m3$fit, eff_var = "lag_lg_hom_odcwho_rate", title = "Effect of Homicides (FEGLS)")
IntPlot(fit = results$ests$fe$m4$fit, eff_var = "lag_lg_hom_odcwho_rate", title = "Effect of Homicides (FE)")
IntPlot(fit = results$ests$fegls$m4$fit, eff_var = "lag_lg_hom_odcwho_rate", title = "Effect of Homicides (FEGLS)")
...
results$tests
```
```{r int_daly_lpi, fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%", fig.show = 'hold'}
IntPlot(fit = results$ests$fe$m3$fit, eff_var = "lag_latentmean_fariss", title = "Effect of Latent Physical Integrity (FE)")
IntPlot(fit = results$ests$fegls$m3$fit, eff_var = "lag_latentmean_fariss", title = "Effect of Latent Physical Integrity (FEGLS)")
IntPlot(fit = results$ests$fe$m4$fit, eff_var = "lag_latentmean_fariss", title = "Effect of Latent Physical Integrity (FE)")
IntPlot(fit = results$ests$fegls$m4$fit, eff_var = "lag_latentmean_fariss", title = "Effect of Latent Physical Integrity (FEGLS)")
...
results$tests
```
```{r int_daly_killings, fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%", fig.show = 'hold'}
IntPlot(fit = results$ests$fe$m3$fit, eff_var = "lag_v2clkill", title = "Effect of Extra-Judicial Killings (FE)")
IntPlot(fit = results$ests$fegls$m3$fit, eff_var = "lag_v2clkill", title = "Effect of Extra-Judicial Killings (FEGLS)")
IntPlot(fit = results$ests$fe$m4$fit, eff_var = "lag_v2clkill", title = "Effect of Extra-Judicial Killings (FE)")
IntPlot(fit = results$ests$fegls$m4$fit, eff_var = "lag_v2clkill", title = "Effect of Extra-Judicial Killings (FEGLS)")
...
results$tests
```
```{r int_daly_torture, fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%", fig.show = 'hold'}
IntPlot(fit = results$ests$fe$m3$fit, eff_var = "lag_v2cltort", title = "Effect of State Torture (FE)")
IntPlot(fit = results$ests$fegls$m3$fit, eff_var = "lag_v2cltort", title = "Effect of State Torture (FEGLS)")
IntPlot(fit = results$ests$fe$m4$fit, eff_var = "lag_v2cltort", title = "Effect of State Torture (FE)")
IntPlot(fit = results$ests$fegls$m4$fit, eff_var = "lag_v2cltort", title = "Effect of State Torture (FEGLS)")
...
results$tests
```
```{r int_labor_conflict_incidence, fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%", fig.show = 'hold'}
IntPlot(fit = results$ests$fe$m3$fit, eff_var = "lag_conflict_internal", title = "Effect of Internal Conflict (FE)")
IntPlot(fit = results$ests$fegls$m3$fit, eff_var = "lag_conflict_internal", title = "Effect of Internal Conflict (FEGLS)")
IntPlot(fit = results$ests$fe$m4$fit, eff_var = "lag_conflict_internal", title = "Effect of Internal Conflict (FE)")
IntPlot(fit = results$ests$fegls$m4$fit, eff_var = "lag_conflict_internal", title = "Effect of Internal Conflict (FEGLS)")
...
results$tests
```
```{r int_labor_war_incidence, fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%", fig.show = 'hold'}
IntPlot(fit = results$ests$fe$m3$fit, eff_var = "lag_war_internal", title = "Effect of Internal War (FE)")
IntPlot(fit = results$ests$fegls$m3$fit, eff_var = "lag_war_internal", title = "Effect of Internal War (FEGLS)")
IntPlot(fit = results$ests$fe$m4$fit, eff_var = "lag_war_internal", title = "Effect of Internal Conflict (FE)")
IntPlot(fit = results$ests$fegls$m4$fit, eff_var = "lag_war_internal", title = "Effect of Internal Conflict (FEGLS)")
...
results$tests
```
```{r int_labor_conflict_deaths, fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%", fig.show = 'hold'}
IntPlot(fit = results$ests$fe$m3$fit, eff_var = "lag_lg_deaths_all_int_rate", title = "Effect of Conflict Deaths (FE)")
IntPlot(fit = results$ests$fegls$m3$fit, eff_var = "lag_lg_deaths_all_int_rate", title = "Effect of Conflict Deaths (FEGLS)")
IntPlot(fit = results$ests$fe$m4$fit, eff_var = "lag_lg_deaths_all_int_rate", title = "Effect of Internal Conflict Deaths (FE)")
IntPlot(fit = results$ests$fegls$m4$fit, eff_var = "lag_lg_deaths_all_int_rate", title = "Effect of Internal Conflict Deaths (FEGLS)")
...
results$tests
```
```{r int_labor_conflict_deaths_civ, fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%", fig.show = 'hold'}
IntPlot(fit = results$ests$fe$m3$fit, eff_var = "lag_lg_deaths_civilians_int_rate", title = "Effect of Civilian Conflict Deaths (FE)")
IntPlot(fit = results$ests$fegls$m3$fit, eff_var = "lag_lg_deaths_civilians_int_rate", title = "Effect of Civilian Conflict Deaths (FEGLS)")
IntPlot(fit = results$ests$fe$m4$fit, eff_var = "lag_lg_deaths_civilians_int_rate", title = "Effect of Conflict Civilian Deaths (FE)")
IntPlot(fit = results$ests$fegls$m4$fit, eff_var = "lag_lg_deaths_civilians_int_rate", title = "Effect of Conflict Civilian Deaths (FEGLS)")
...
results$tests
```
```{r int_labor_osv_incidence, fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%", fig.show = 'hold'}
IntPlot(fit = results$ests$fe$m3$fit, eff_var = "lag_conflict_one_sided", title = "Effect of One-Sided Violence (FE)")
IntPlot(fit = results$ests$fegls$m3$fit, eff_var = "lag_conflict_one_sided", title = "Effect of One-Sided Violence (FEGLS)")
IntPlot(fit = results$ests$fe$m4$fit, eff_var = "lag_conflict_one_sided", title = "Effect of One-sided Violence (FE)")
IntPlot(fit = results$ests$fegls$m4$fit, eff_var = "lag_conflict_one_sided", title = "Effect of One-sided Violence (FEGLS)")
...
results$tests
```
```{r int_labor_osv_deaths, fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%", fig.show = 'hold'}
IntPlot(fit = results$ests$fe$m3$fit, eff_var = "lag_lg_deaths_civilians_osv_rate", title = "Effect of OSV Deaths (FE)")
IntPlot(fit = results$ests$fegls$m3$fit, eff_var = "lag_lg_deaths_civilians_osv_rate", title = "Effect of OSV Deaths (FEGLS)")
IntPlot(fit = results$ests$fe$m4$fit, eff_var = "lag_lg_deaths_civilians_osv_rate", title = "Effect of OSV Deaths (FE)")
IntPlot(fit = results$ests$fegls$m4$fit, eff_var = "lag_lg_deaths_civilians_osv_rate", title = "Effect of OSV Deaths (FEGLS)")
...
results$tests
```
```{r int_labor_nsc_incidence, fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%", fig.show = 'hold'}
IntPlot(fit = results$ests$fe$m3$fit, eff_var = "lag_conflict_non_state", title = "Effect of Non-state Conflict (FE)")
IntPlot(fit = results$ests$fegls$m3$fit, eff_var = "lag_conflict_non_state", title = "Effect of Non-state Conflict (FEGLS)")
IntPlot(fit = results$ests$fe$m4$fit, eff_var = "lag_conflict_non_state", title = "Effect of Non-state Conflict (FE)")
IntPlot(fit = results$ests$fegls$m4$fit, eff_var = "lag_conflict_non_state", title = "Effect of Non-state Conflict (FEGLS)")
...
results$tests
```
```{r int_labor_nsc_deaths, fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%", fig.show = 'hold'}
IntPlot(fit = results$ests$fe$m3$fit, eff_var = "lag_lg_deaths_all_nsc_rate", title = "Effect of Non-state Conflict Deaths (FE)")
IntPlot(fit = results$ests$fegls$m3$fit, eff_var = "lag_lg_deaths_all_nsc_rate", title = "Effect of Non-state Conflict Deaths (FEGLS)")
IntPlot(fit = results$ests$fe$m4$fit, eff_var = "lag_lg_deaths_all_nsc_rate", title = "Effect of Non-state Conflict Deaths (FE)")
IntPlot(fit = results$ests$fegls$m4$fit, eff_var = "lag_lg_deaths_all_nsc_rate", title = "Effect of Non-state Conflict Deaths (FEGLS)")
...
results$tests
```
```{r int_labor_nsc_deaths_civ, fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%", fig.show = 'hold'}
IntPlot(fit = results$ests$fe$m3$fit, eff_var = "lag_lg_deaths_civilians_nsc_rate", title = "Effect of Non-state Conflict Civilian Deaths (FE)")
IntPlot(fit = results$ests$fegls$m3$fit, eff_var = "lag_lg_deaths_civilians_nsc_rate", title = "Effect of Non-state Conflict Civilian Deaths (FEGLS)")
IntPlot(fit = results$ests$fe$m4$fit, eff_var = "lag_lg_deaths_civilians_nsc_rate", title = "Effect of Non-state Conflict Civilian Deaths (FE)")
IntPlot(fit = results$ests$fegls$m4$fit, eff_var = "lag_lg_deaths_civilians_nsc_rate", title = "Effect of Non-state Conflict Civilian Deaths (FEGLS)")
...
results$tests
```
```{r int_labor_homicides, fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%", fig.show = 'hold'}
IntPlot(fit = results$ests$fe$m3$fit, eff_var = "lag_lg_hom_odcwho_rate", title = "Effect of Homicides (FE)")
IntPlot(fit = results$ests$fegls$m3$fit, eff_var = "lag_lg_hom_odcwho_rate", title = "Effect of Homicides (FEGLS)")
IntPlot(fit = results$ests$fe$m4$fit, eff_var = "lag_lg_hom_odcwho_rate", title = "Effect of Homicides (FE)")
IntPlot(fit = results$ests$fegls$m4$fit, eff_var = "lag_lg_hom_odcwho_rate", title = "Effect of Homicides (FEGLS)")
...
results$tests
```
```{r int_labor_lpi, fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%", fig.show = 'hold'}
IntPlot(fit = results$ests$fe$m3$fit, eff_var = "lag_latentmean_fariss", title = "Effect of Latent Physical Integrity (FE)")
IntPlot(fit = results$ests$fegls$m3$fit, eff_var = "lag_latentmean_fariss", title = "Effect of Latent Physical Integrity (FEGLS)")
IntPlot(fit = results$ests$fe$m4$fit, eff_var = "lag_latentmean_fariss", title = "Effect of Latent Physical Integrity (FE)")
IntPlot(fit = results$ests$fegls$m4$fit, eff_var = "lag_latentmean_fariss", title = "Effect of Latent Physical Integrity (FEGLS)")
...
results$tests
```
```{r int_labor_killings, fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%", fig.show = 'hold'}
IntPlot(fit = results$ests$fe$m3$fit, eff_var = "lag_v2clkill", title = "Effect of Extra-Judicial Killings (FE)")
IntPlot(fit = results$ests$fegls$m3$fit, eff_var = "lag_v2clkill", title = "Effect of Extra-Judicial Killings (FEGLS)")
IntPlot(fit = results$ests$fe$m4$fit, eff_var = "lag_v2clkill", title = "Effect of Extra-Judicial Killings (FE)")
IntPlot(fit = results$ests$fegls$m4$fit, eff_var = "lag_v2clkill", title = "Effect of Extra-Judicial Killings (FEGLS)")
...
results$tests
```
```{r int_labor_torture, fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%", fig.show = 'hold'}
IntPlot(fit = results$ests$fe$m3$fit, eff_var = "lag_v2cltort", title = "Effect of State Torture (FE)")
IntPlot(fit = results$ests$fegls$m3$fit, eff_var = "lag_v2cltort", title = "Effect of State Torture (FEGLS)")
IntPlot(fit = results$ests$fe$m4$fit, eff_var = "lag_v2cltort", title = "Effect of State Torture (FE)")
IntPlot(fit = results$ests$fegls$m4$fit, eff_var = "lag_v2cltort", title = "Effect of State Torture (FEGLS)")
...
results$tests
```
```{r int_gii_conflict_incidence, fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%", fig.show = 'hold'}
IntPlot(fit = results$ests$fe$m3$fit, eff_var = "lag_conflict_internal", title = "Effect of Internal Conflict (FE)")
IntPlot(fit = results$ests$fegls$m3$fit, eff_var = "lag_conflict_internal", title = "Effect of Internal Conflict (FEGLS)")
IntPlot(fit = results$ests$fe$m4$fit, eff_var = "lag_conflict_internal", title = "Effect of Internal Conflict (FE)")
IntPlot(fit = results$ests$fegls$m4$fit, eff_var = "lag_conflict_internal", title = "Effect of Internal Conflict (FEGLS)")
...
results$tests
```
```{r int_gii_war_incidence, fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%", fig.show = 'hold'}
IntPlot(fit = results$ests$fe$m3$fit, eff_var = "lag_war_internal", title = "Effect of Internal War (FE)")
IntPlot(fit = results$ests$fegls$m3$fit, eff_var = "lag_war_internal", title = "Effect of Internal War (FEGLS)")
IntPlot(fit = results$ests$fe$m4$fit, eff_var = "lag_war_internal", title = "Effect of Internal Conflict (FE)")
IntPlot(fit = results$ests$fegls$m4$fit, eff_var = "lag_war_internal", title = "Effect of Internal Conflict (FEGLS)")
...
results$tests
```
```{r int_gii_conflict_deaths, fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%", fig.show = 'hold'}
IntPlot(fit = results$ests$fe$m3$fit, eff_var = "lag_lg_deaths_all_int_rate", title = "Effect of Conflict Deaths (FE)")
IntPlot(fit = results$ests$fegls$m3$fit, eff_var = "lag_lg_deaths_all_int_rate", title = "Effect of Conflict Deaths (FEGLS)")
IntPlot(fit = results$ests$fe$m4$fit, eff_var = "lag_lg_deaths_all_int_rate", title = "Effect of Internal Conflict Deaths (FE)")
IntPlot(fit = results$ests$fegls$m4$fit, eff_var = "lag_lg_deaths_all_int_rate", title = "Effect of Internal Conflict Deaths (FEGLS)")
...
results$tests
```
```{r int_gii_conflict_deaths_civ, fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%", fig.show = 'hold'}
IntPlot(fit = results$ests$fe$m3$fit, eff_var = "lag_lg_deaths_civilians_int_rate", title = "Effect of Civilian Conflict Deaths (FE)")
IntPlot(fit = results$ests$fegls$m3$fit, eff_var = "lag_lg_deaths_civilians_int_rate", title = "Effect of Civilian Conflict Deaths (FEGLS)")
IntPlot(fit = results$ests$fe$m4$fit, eff_var = "lag_lg_deaths_civilians_int_rate", title = "Effect of Conflict Civilian Deaths (FE)")
IntPlot(fit = results$ests$fegls$m4$fit, eff_var = "lag_lg_deaths_civilians_int_rate", title = "Effect of Conflict Civilian Deaths (FEGLS)")
...
results$tests
```
```{r int_gii_osv_incidence, fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%", fig.show = 'hold'}
IntPlot(fit = results$ests$fe$m3$fit, eff_var = "lag_conflict_one_sided", title = "Effect of One-Sided Violence (FE)")
IntPlot(fit = results$ests$fegls$m3$fit, eff_var = "lag_conflict_one_sided", title = "Effect of One-Sided Violence (FEGLS)")
IntPlot(fit = results$ests$fe$m4$fit, eff_var = "lag_conflict_one_sided", title = "Effect of One-sided Violence (FE)")
IntPlot(fit = results$ests$fegls$m4$fit, eff_var = "lag_conflict_one_sided", title = "Effect of One-sided Violence (FEGLS)")
...
results$tests
```
```{r int_gii_osv_deaths, fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%", fig.show = 'hold'}
IntPlot(fit = results$ests$fe$m3$fit, eff_var = "lag_lg_deaths_civilians_osv_rate", title = "Effect of OSV Deaths (FE)")
IntPlot(fit = results$ests$fegls$m3$fit, eff_var = "lag_lg_deaths_civilians_osv_rate", title = "Effect of OSV Deaths (FEGLS)")
IntPlot(fit = results$ests$fe$m4$fit, eff_var = "lag_lg_deaths_civilians_osv_rate", title = "Effect of OSV Deaths (FE)")
IntPlot(fit = results$ests$fegls$m4$fit, eff_var = "lag_lg_deaths_civilians_osv_rate", title = "Effect of OSV Deaths (FEGLS)")
...
results$tests
```
```{r int_gii_nsc_incidence, fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%", fig.show = 'hold'}
IntPlot(fit = results$ests$fe$m3$fit, eff_var = "lag_conflict_non_state", title = "Effect of Non-state Conflict (FE)")
IntPlot(fit = results$ests$fegls$m3$fit, eff_var = "lag_conflict_non_state", title = "Effect of Non-state Conflict (FEGLS)")
IntPlot(fit = results$ests$fe$m4$fit, eff_var = "lag_conflict_non_state", title = "Effect of Non-state Conflict (FE)")
IntPlot(fit = results$ests$fegls$m4$fit, eff_var = "lag_conflict_non_state", title = "Effect of Non-state Conflict (FEGLS)")
...
results$tests
```
```{r int_gii_nsc_deaths, fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%", fig.show = 'hold'}
IntPlot(fit = results$ests$fe$m3$fit, eff_var = "lag_lg_deaths_all_nsc_rate", title = "Effect of Non-state Conflict Deaths (FE)")
IntPlot(fit = results$ests$fegls$m3$fit, eff_var = "lag_lg_deaths_all_nsc_rate", title = "Effect of Non-state Conflict Deaths (FEGLS)")
IntPlot(fit = results$ests$fe$m4$fit, eff_var = "lag_lg_deaths_all_nsc_rate", title = "Effect of Non-state Conflict Deaths (FE)")
IntPlot(fit = results$ests$fegls$m4$fit, eff_var = "lag_lg_deaths_all_nsc_rate", title = "Effect of Non-state Conflict Deaths (FEGLS)")
...
results$tests
```
```{r int_gii_nsc_deaths_civ, fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%", fig.show = 'hold'}
IntPlot(fit = results$ests$fe$m3$fit, eff_var = "lag_lg_deaths_civilians_nsc_rate", title = "Effect of Non-state Conflict Civilian Deaths (FE)")
IntPlot(fit = results$ests$fegls$m3$fit, eff_var = "lag_lg_deaths_civilians_nsc_rate", title = "Effect of Non-state Conflict Civilian Deaths (FEGLS)")
IntPlot(fit = results$ests$fe$m4$fit, eff_var = "lag_lg_deaths_civilians_nsc_rate", title = "Effect of Non-state Conflict Civilian Deaths (FE)")
IntPlot(fit = results$ests$fegls$m4$fit, eff_var = "lag_lg_deaths_civilians_nsc_rate", title = "Effect of Non-state Conflict Civilian Deaths (FEGLS)")
...
results$tests
```
```{r int_gii_homicides, fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%", fig.show = 'hold'}
IntPlot(fit = results$ests$fe$m3$fit, eff_var = "lag_lg_hom_odcwho_rate", title = "Effect of Homicides (FE)")
IntPlot(fit = results$ests$fegls$m3$fit, eff_var = "lag_lg_hom_odcwho_rate", title = "Effect of Homicides (FEGLS)")
IntPlot(fit = results$ests$fe$m4$fit, eff_var = "lag_lg_hom_odcwho_rate", title = "Effect of Homicides (FE)")
IntPlot(fit = results$ests$fegls$m4$fit, eff_var = "lag_lg_hom_odcwho_rate", title = "Effect of Homicides (FEGLS)")
...
results$tests
```
```{r int_gii_lpi, fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%", fig.show = 'hold'}
IntPlot(fit = results$ests$fe$m3$fit, eff_var = "lag_latentmean_fariss", title = "Effect of Latent Physical Integrity (FE)")
IntPlot(fit = results$ests$fegls$m3$fit, eff_var = "lag_latentmean_fariss", title = "Effect of Latent Physical Integrity (FEGLS)")
IntPlot(fit = results$ests$fe$m4$fit, eff_var = "lag_latentmean_fariss", title = "Effect of Latent Physical Integrity (FE)")
IntPlot(fit = results$ests$fegls$m4$fit, eff_var = "lag_latentmean_fariss", title = "Effect of Latent Physical Integrity (FEGLS)")
...
results$tests
```
```{r int_gii_killings, fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%", fig.show = 'hold'}
IntPlot(fit = results$ests$fe$m3$fit, eff_var = "lag_v2clkill", title = "Effect of Extra-Judicial Killings (FE)")
IntPlot(fit = results$ests$fegls$m3$fit, eff_var = "lag_v2clkill", title = "Effect of Extra-Judicial Killings (FEGLS)")
IntPlot(fit = results$ests$fe$m4$fit, eff_var = "lag_v2clkill", title = "Effect of Extra-Judicial Killings (FE)")
IntPlot(fit = results$ests$fegls$m4$fit, eff_var = "lag_v2clkill", title = "Effect of Extra-Judicial Killings (FEGLS)")
...
results$tests
```
```{r int_gii_torture, fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%", fig.show = 'hold'}
IntPlot(fit = results$ests$fe$m3$fit, eff_var = "lag_v2cltort", title = "Effect of State Torture (FE)")
IntPlot(fit = results$ests$fegls$m3$fit, eff_var = "lag_v2cltort", title = "Effect of State Torture (FEGLS)")
IntPlot(fit = results$ests$fe$m4$fit, eff_var = "lag_v2cltort", title = "Effect of State Torture (FE)")
IntPlot(fit = results$ests$fegls$m4$fit, eff_var = "lag_v2cltort", title = "Effect of State Torture (FEGLS)")
...
```
```{r violence_corr, message = FALSE, warning = FALSE, results = 'hide'}
