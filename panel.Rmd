...
#       "p-value" = round(2* pnorm(q = -abs(results$ests$fegls$m1$fit$coef) / sqrt(diag(results$ests$fegls$m1$fit$vcov)), lower.tail = TRUE), 7))
...
MakeTable(results$ests$fegls, dv = "health", confl = "war", estimator = "fegls", dist = "pnorm")
```
...
MakeTable(results$ests$fegls, dv = "gender", confl = "conflict", estimator = "fegls", dist = "pnorm")
```
...
MakeTable(results$ests$fegls, dv = "gender", confl = "war", estimator = "fegls", dist = "pnorm")
```
...
MakeTable(results$ests$fegls, dv = "conflict", estimator = "fegls", dist = "pnorm")
```
...
MakeTable(results$ests$fegls, dv = "war", estimator = "fegls", dist = "pnorm")
```
...
MakeTable(results$ests$fegls, dv = "repression", estimator = "fegls", dist = "pnorm")
```
