...
```
```{r conflict_data, rows.print = 15, cols.print = 10, cols.min.print = 10}
# round(prop.table(table(new[, c("typology1975", "conflict_1971_2015")])) * 100, 1)
# round(addmargins(prop.table(table(new[, c("typology1975", "conflict_1971_2015")]), margin = 2), margin = 1), 3)
...
```
```{r lpi_data, rows.print = 15, cols.print = 10, cols.min.print = 10}
round(prop.table(table(new[, c("typology1975", "latentmean_fariss_1971_2015")])) * 100, 1) 
...
```
```{r killings_data, rows.print = 15, cols.print = 10, cols.min.print = 10}
...
```
```{r torture_data, rows.print = 15, cols.print = 10, cols.min.print = 10}
...
```
```{r societal_data, rows.print = 15, cols.print = 10, cols.min.print = 10}
