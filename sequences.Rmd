...
plotClass <- function(class, dat, range) {
  ggplot(data = dat, 
    ...
    theme_classic() + theme(legend.position = "none") + ggtitle(paste(class, " (", lookup[class], ")", sep = ""))
}
...
lapply(c("low", "H>G", "G>H", "mid", "upp"), function(class) {
  plotClass(class = class, 
            dat = new1975[new1975$class_vv1975 == class & !is.na(new1975$lag_health) & !is.na(new1975$lag_gender), ], 
...
lapply(c("low", "H>G", "G>H", "mid", "upp"), function(class) {
  plotClass(class = class, 
            dat = new1995[new1995$class_vv1975 == class & !is.na(new1995$lag_health) & !is.na(new1995$lag_gender), ], 
            range = range_both_new)
})
```
