...
```{r cross-tabs, include = FALSE, eval = FALSE}
...
ggplot(data = new[!is.na(new$class_vv1995) & new$conflict_1976_1995 == "none", ], 
  ...
  theme(legend.position = "top", legend.key.size = unit(0.3, 'cm')) + 
  labs(y = "Number of countries", x = "")
ggsave(device = "pdf", height = 4, width = 6.5, filename = "_figures/class_conflict_1995_1976_prenone.pdf")
# round(addmargins(prop.table(table(new[new$conflict_1976_1995 != "none", c("conflict_1996_2015", "class_vv1995")]), margin = 2), margin = 1), 3) * 100
ggplot(data = new[!is.na(new$class_vv1995) & new$conflict_1976_1995 != "none", ], 
       mapping = aes(x = class_vv1995, fill = conflict_1996_2015)) +
  geom_bar(stat = "count", position = position_dodge2(preserve = "single")) +
  ...
  theme(legend.position = "top", legend.key.size = unit(0.3, 'cm')) + 
  labs(y = "Number of countries", x = "")
ggsave(device = "pdf", height = 4, width = 6.5, filename = "_figures/class_conflict_1995_1976_presome.pdf")
```
...
ggplot(data = new, mapping = aes(x = health_period, y = typology1975)) +
  ...
  labs(x = "Health change per period", y = "Sequence (1971-2015)") + 
  theme_minimal()
...
ggplot(data = new, mapping = aes(x = gender_period, y = typology1975)) +
  ...
  # stat_summary(fun.data = data_summary, geom = "pointrange") + 
  geom_vline(xintercept = 0, color = "gray") + 
  labs(x = "Gender change per period", y = "Sequence (1971-2015)") + 
  theme_minimal()
...
ggplot(data = new, mapping = aes(x = dist_period, y = typology1975)) +
  ...
  stat_summary(fun = mean, geom = "point", shape = 18) +
  # stat_summary(fun.data = data_summary, geom = "pointrange") + 
  labs(x = "Health & gender change per period", y = "Sequence (1971-2015)") + 
  geom_vline(xintercept = 0, color = "gray") + 
  theme_minimal()
...
ggplot(data = new, mapping = aes(x = dist_total, y = typology1975)) +
  ...
  # stat_summary(fun.data = data_summary, geom = "pointrange") + 
  geom_vline(xintercept = 0, color = "gray") + 
  labs(x = "Path efficiency", y = "Sequence (1971-2015)") + 
  theme_minimal()
...
ggplot(data = new, 
  ...
  labs(x = "Number of countries", y = "Sequence (1971-2015)")
...
ggplot(data = new, mapping = aes(x = latentmean_fariss_1971_2015, y = typology1975)) +
  ...
  # stat_summary(fun.data = data_summary, geom = "pointrange") + 
  theme_minimal() + 
  labs(x = "Average LPI", y = "Sequence (1971-2015)")
...
ggplot(data = new, mapping = aes(x = v2clkill_1971_2015, y = typology1975)) +
  ...
  # stat_summary(fun.data = data_summary, geom = "pointrange") + 
  theme_minimal() + 
  labs(x = "Average extrajudicial killings score", y = "Sequence (1971-2015)")
...
ggplot(data = new, mapping = aes(x = v2caviol_1971_2015, y = typology1975)) +
  ...
  theme_minimal() + 
  labs(x = "Average societal violence score", y = "Sequence (1971-2015)")
