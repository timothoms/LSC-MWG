...
lapply(c("low", "H>G", "G>H", "mid", "upp"), function(class) {
  plotClass(class = class, 
            ...
            range = range_both)
  ggsave(device = "pdf", height = 5, width = 5, 
         filename = paste("_figures/sequences_class1975_", class, ".pdf", sep = ""))
})
...
lapply(c("low", "H>G", "G>H", "mid", "upp"), function(class) {
  ...
  ggsave(device = "pdf", height = 5, width = 5, 
       filename = paste("_figures/sequences_class1975_origin_", class, ".pdf", sep = ""))
})
```
...
lapply(c("low", "H>G", "G>H", "mid", "upp"), function(class) {
  plotClass(class = class, 
            ...
            range = range_both)
  ggsave(device = "pdf", height = 5, width = 5, 
       filename = paste("_figures/sequences_class1995_", class, ".pdf", sep = ""))
})
...
lapply(c("low", "H>G", "G>H", "mid", "upp"), function(class) {
  plotClass(class = class, 
            ...
            range = range_both_new)
  ggsave(device = "pdf", height = 5, width = 5, 
       filename = paste("_figures/sequences_class1995_origin_", class, ".pdf", sep = ""))
})
```
...
lapply(sort(unique(df$typology1975)), function(sequ) {
  plotCategory(cat = sequ,
           ...
           range = range_both)
  ggsave(device = "pdf", height = 5, width = 5, 
    filename = paste("_figures/sequences_typology1975_", which(names(lookup) == sequ), ".pdf", sep = ""))
})
```
...
lapply(sort(unique(df$typology1995)), function(sequ) {
  plotCategory(cat = sequ, 
           ...
           range = range_both)
  ggsave(device = "pdf", height = 5, width = 5, 
    filename = paste("_figures/sequences_typology1995_", which(names(lookup) == sequ), ".pdf", sep = ""))
})
```
