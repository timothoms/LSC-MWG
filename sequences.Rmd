...
#### Bivariate {.tabset .tabset-fade .tabset-pills}

##### Health change
```{r bivariate_health, fig.show = "hold", fig.width = 5, fig.height = 5, out.width = "50%", out.height = "50%"}
...
ggplot(data = new, mapping = aes(x = health_period, y = typology1975)) +
  stat_summary(fun.data = data_summary, geom = "pointrange") + theme_minimal()
# round(addmargins(prop.table(table(new[, c("typology1975", "health_period_quart")]), margin = 1) * 100, margin = 2), 1)
```

##### Gender change
```{r bivariate_gender, fig.show = "hold", fig.width = 5, fig.height = 5, out.width = "50%", out.height = "50%"}
...
##### Overall change
```{r bivariate_both, fig.show = "hold", fig.width = 5, fig.height = 5, out.width = "50%", out.height = "50%"}
...
##### Path efficiency
```{r bivariate_path_efficiency, fig.show = "hold", fig.width = 5, fig.height = 5, out.width = "50%", out.height = "50%"}
...
round(addmargins(prop.table(table(new[, c("typology1995", "conflict_1991_2015")])[, c(3, 1:2, 4:5)], margin = 1) * 100, margin = 2), 1)
addmargins(table(new[, c("typology1995", "conflict_1991_2015")])[, c(3, 1:2, 4:5)])
```
