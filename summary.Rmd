...
| G>H classification        |$(-)$[upp]/$+$[low]|    $(-)$|         $(-)$[upp]|$(+)$[mid]|        |                     $+$[low]|                      $-$[low]|       |
| mid classification        |           $+$[low]|         |                   |$(-)$[low]|$+$[low]|                     $+$[low]|                              |       |
| upp classification        |           $+$[low]|         |                   |          |$+$[low]|                     $+$[low]|                              |       |
|                           |                   |         |                   |          |        |                             |                              |       |
| **_Internal Conflict_**   |**Life Expectancy**|**IMR**  |**UFMR**           |**DALYs** |**MYS** |**Adolescent Fertility Rate**|**Labour Participation Ratio**|**GII**|
| Conflict                  |                $+$|         |                   |       $+$|        |                             |                           $-$|    $+$|
| Conflict: low             |                $+$|         |                   |          |        |                             |                              |  $(+)$|
| Conflict: H>G             |              $(+)$|      $+$|                   |          |        |                          $-$|                              |    $+$|
| Conflict: G>H             |                   |      $-$|                   |     $(+)$|        |                             |                         $(-)$|       |
...
|                           |                   |         |                   |          |        |                             |                              |       |
| **_One-sided Violence_**  |**Life Expectancy**|**IMR**  |**UFMR**           |**DALYs** |**MYS** |**Adolescent Fertility Rate**|**Labour Participation Ratio**|**GII**|
| OSV                       |                   |    $(-)$|              $(-)$|          |        |                             |                              |       |
| OSV: low                  |                   |      $-$|                $-$|          |     $+$|                          $+$|                              |       |
| OSV: H>G                  |                   |         |                   |          |        |                             |                              |    $+$|
| OSV: G>H                  |                $+$|         |                   |          |        |                             |                              |       |
...
| OSV Deaths: upp           |                   |         |                   |          |        |                             |                           $-$|       |
|                           |                   |         |                   |          |        |                             |                              |       |
| **_Societal Violence_**   |**Life Expectancy**|**IMR**  |**UFMR**           |**DALYs** |**MYS** |**Adolescent Fertility Rate**|**Labour Participation Ratio**|**GII**|
| NSC                       |                   |         |                   |       $+$|        |                          $+$|                              |       |
| NSC: low                  |                   |         |                   |       $+$|        |                          $+$|                              |       |
| NSC: H>G                  |                   |    $(-)$|              $(-)$|          |        |                          $+$|                              |    $-$|
| NSC: G>H                  |                   |         |                   |          |        |                             |                              |       |
...
|                           |                   |         |                   |          |        |                             |                              |       |
| **_State Repression_**    |**Life Expectancy**|**IMR**  |**UFMR**           |**DALYs** |**MYS** |**Adolescent Fertility Rate**|**Labour Participation Ratio**|**GII**|
| LPI                       |                   |      $+$|                $+$|       $+$|        |                        $(+)$|                              |    $+$|
| LPI: low                  |                   |         |          $+$[prev]|          |        |                          $+$|                              |       |
| LPI: H>G                  |                   |      $+$|                $+$|     $(+)$|     $-$|                          $-$|                              |       |
| LPI: G>H                  |                   |         |                $+$|       $+$|     $-$|                          $+$|                              |       |
...
|                           | Conflict | War    | Confl. Deaths | Civ. Deaths | OSV | OSV Deaths | NSC    | NSC Deaths | NSC Civ. Deaths | Homicides | LPI             | Torture | Killings |
|:--------------------------|:--------:|:------:|:-------------:|:-----------:|:---:|:----------:|:------:|:----------:|:---------------:|:---------:|----------------:|:-------:|:--------:|
| Life Expectancy           |          |        |               |          $+$|  $-$|       $[+]$|        |            |                 |           |              $+$|    $(-)$|          |
| Infant Mortality          |       $-$|        |               |             |$(-)$|            |        |            |                 |           |            $(-)$|         |          |
| MYS Ratio                 |          |     $-$|               |             |     |         $-$|        |            |                 |           |              $-$|         |          |
