...
| health               | _infant mortality rate_                                  | WPP     |
| gender               | mean years of schooling ratio                            | HDR     |
...
| $[]$   | statistical effect contradicting theoretical expectations     |
| $()$   | statistical effect not found in the preferred model (FE GGLS) |
| ~      | statistically significant interaction term but overall interaction effect is not statistically significant |
...
##### Health & Gender Results

|                                            | Life Expectancy | Infant Mortality | Mean Years of Schooling | Adolescent Fertility Rate |
|--------------------------------------------|-----------------|------------------|-------------------------|---------------------------|
| Life Expectancy                            |   na|     na|       |    $+$|
| Infant Mortality                           |   na|     na|       |    $+$|
| Mean Years of Schooling ratio              |  $+$|    $+$|     na|     na|
| Adolescent Fertility Rate                  |  $+$|  $[-]$|     na|     na|
| low classification                         |  $-$|    $-$|    $-$|    $-$|
| high classification                        |     |       |       |       |
| Conflict                                   |$[+]$|       |       |       |
| Conflict: low interaction                  |     |       |       |       |
| Conflict: high interaction                 |     |    $+$|       |       |
| War                                        |     |       |       |    $-$|
| War: low interaction                       |     |       |       |       |
| War: high interaction                      |     |       |       |       |
| Conflict Deaths                            |     |    $-$|       |  $[+]$|
| Conflict Deaths: low interaction           |     |       |       |  $[+]$|
| Conflict Deaths: high interaction          |     |       |       |       |
| Conflict Civilian Deaths                   |$[+]$|       |       |  $[+]$|
| Conflict Civilian Deaths: low interaction  |$[+]$|       |       |  $[+]$|
| Conflict Civilian Deaths: high interaction |     |       |       |       |
| OSV                                        |     |  $(-)$|       |       |
| OSV: low interaction                       |    ~|  $(-)$|  $[+]$|  $[+]$|
| OSV: high interaction                      |     |       |       |       |
| OSV Deaths                                 |$[+]$|  $(-)$|       |  $[+]$|
| OSV Deaths: low interaction                |     |       |       |       |
| OSV Deaths: high interaction               |     |       |       |       |
| NSC                                        |     |       |       |  $[+]$|
| NSC: low interaction                       |     |       |       |       |
| NSC: high interaction                      |     |       |       |       |
| NSC Deaths                                 |$[+]$|       |       |  $[+]$|
| NSC Deaths: low interaction                |     |       |       |       |
| NSC Deaths: high interaction               |     |$[(+)]$|       |       |
| NSC Civilian Deaths                        |$[+]$|       |       |  $[+]$|
| NSC Civilian Deaths: low interaction       |     |       |       |       |
| NSC Civilian Deaths: high interaction      |     |       |$[(-)]$|       |
| LPI                                        |     |  $[+]$|    $-$|$[(+)]$|
| LPI: low interaction                       |     |      ~|       |       |
| LPI: high interaction                      |    ~|  $(+)$|      ~|       |
| Torture                                    |     |       |       |       |
| Torture: low interaction                   |     |      ~|       |      ~|
| Torture: high interaction                  |     |  $(+)$|      ~|       |
| Killings                                   |     |       |       |       |
| Killings: low interaction                  |  $-$|    $-$|       |       |
| Killings: high interaction                 |     |  $(+)$|      ~|       |
| Homicides                                  |  $-$|  $[+]$|       |  $[+]$|
| Homicides: low interaction                 |     |       |       |       |
| Homicides: high interaction                |     |      ~|       |       |

##### Violence Results

|                           | Conflict | War | Conflict Deaths | Conflict Civilian Deaths | OSV | OSV Deaths | NSC | NSC Deaths | NSC Civilian Deaths | LPI | Torture | Killings | Homicides |
|---------------------------|----------|-----|-----------------|--------------------------|-----|------------|-----|------------|---------------------|-----|---------|----------|-----------|
| Life Expectancy           |   |   |   |$[+]$|  $-$|$[(+)]$|     |   |   |    $[+]$|$(-)$|       |       |
| Infant Mortality          |$-$|   |   |     |$(-)$|       |     |   |   |    $(-)$|     |       |       |
