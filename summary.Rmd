...
**Note:** This section will be updated based on the new results.
...
| low classification        |           $-$[upp]|                         |                   |                     |   $-$[upp]|                          $-$|                              |             |
| H>G classification        |         $(+)$[low]|                         |                   |           $(-)$[low]|   $+$[low]|                     $-$[upp]|                              |             |
| G>H classification        |$(-)$[upp]/$+$[low]|                    $(-)$|         $(-)$[upp]|                     |           |                     $+$[low]|                      $-$[low]|             |
...
| --- low                   |          $-$[viol]|                      $-$|              $(-)$|                  $+$|           |        $(-)$[viol]/$+$[viol]|                              |             |
| --- H>G                   |                   |                         |                   |                     |           |                    $+$[viol]|                              |             |
| --- G>H                   |          $-$[viol]|                $-$[viol]|        $(-)$[viol]|                     |           |        $(+)$[viol]/$-$[viol]|                              |    $-$[viol]|
| --- mid                   |                   |                         |                   |          $(+)$[viol]|  $-$[viol]|                    $-$[viol]|                              |  $(+)$[viol]|
| --- upp                   |                   |                         |                   |                  $+$|           |                  $(-)$[viol]|                              |             |
| Confl. Civ. Deaths (UCDP) |                $+$|                         |                   |                  $+$|           |                          $+$|                              |             |
| --- low                   |                $+$|                         |                   |            $+$[viol]|           |                          $+$|                              |    $-$[viol]|
| --- H>G                   |                   |                         |                   |                     |           |                             |                              |             |
| --- G>H                   |          $-$[viol]|                $-$[viol]|          $-$[viol]|                     |           |                    $-$[viol]|                              |             |
| --- mid                   |                   |              $(-)$[viol]|                   |          $(+)$[viol]|           |                    $-$[viol]|                              |             |
| --- upp                   |                   |                $+$[viol]|                   |                  $+$|           |                             |                              |             |
|                           |                   |                         |                   |                     |           |                             |                              |             |
...
| LPI                       |                   |                      $+$|                $+$|                  $+$|           |                        $(+)$|                         $(-)$|          $+$|
| --- low                   |                   |                $-$[viol]|          $-$[viol]|                     |           |    $+$/$(-)$[viol]/$-$[viol]|                              |             |
| --- H>G                   |                   |$+$/$(+)$[viol]/$-$[viol]|    $+$/$(+)$[viol]|          $(+)$[viol]|  $-$[viol]|              $(+)$/$-$[viol]|                              |    $+$[viol]|
| --- G>H                   |          $+$[viol]|                $+$[viol]|                $+$|                  $+$|  $-$[viol]|                    $+$[viol]|                              |             |
| --- mid                   |                   |          $+$/$(+)$[viol]|    $+$/$(+)$[viol]|          $(+)$[viol]|  $-$[viol]|                             |                              |             |
| --- upp                   |    $(-)$/$-$[viol]|          $+$/$(+)$[viol]|    $+$/$(+)$[viol]|          $(+)$[viol]|           |        $(+)$[viol]/$-$[viol]|                   $(-)$[viol]|    $+$[viol]|
| Killings                  |                   |                         |                   |                     |           |                             |                              |             |
| --- low                   |                   |          $(-)$/$-$[viol]|              $(-)$|            $-$[viol]|           |                    $-$[viol]|                              |             |
| --- H>G                   |                   |                      $+$|    $+$/$(+)$[viol]|          $(+)$[viol]|           |                    $-$[viol]|                              |             |
| --- G>H                   |              $(+)$|                         |                   |          $(+)$[viol]|           |                             |                              |             |
...
| --- G>H                   |              $(-)$|              $(-)$[viol]|                   |                     |           |                  $(+)$[viol]|                              |    $-$[viol]|
| --- mid                   |        $(+)$[viol]|                         |                   |                     |           |                             |                         $(-)$|             |
| --- upp                   |                   |              $(+)$[viol]|        $(+)$[viol]|          $(+)$[viol]|           |                  $(+)$[viol]|                              |             |
| NSC Civ. Deaths (UCDP)    |                $+$|                         |                   |                  $+$|           |                          $+$|                         $(+)$|             |
| --- low                   |                $+$|                $+$[viol]|                   |                  $+$|           |                    $+$[viol]|                   $(+)$[viol]|             |
| --- H>G                   |                   |          $(-)$/$-$[viol]|        $(-)$[viol]|          $(-)$[viol]|           |                             |                   $(-)$[viol]|             |
| --- G>H                   |          $+$[viol]|                      $+$|          $+$[viol]|$(-)$[viol]/$+$[viol]|           |                             |                   $(+)$[viol]|             |
| --- mid                   |                   |                         |                   |                     |           |                             |                              |             |
| --- upp                   |        $(+)$[viol]|              $(+)$[viol]|        $(+)$[viol]|          $(+)$[viol]|      $(-)$|                    $+$[viol]|                   $(+)$[viol]|        $(+)$|
| Homicides                 |                $-$|                      $+$|                $+$|                $(-)$|           |                          $+$|                              |             |
| --- low                   |          $-$[viol]|                $-$[viol]|      $+$/$-$[viol]|            $-$[viol]|           |                    $-$[viol]|                     $+$[viol]|    $-$[viol]|
| --- H>G                   |        $(-)$[viol]|                         |                $+$|                     |           |                    $-$[viol]|                              |             |
| --- G>H                   |          $-$[viol]|                      $+$|                   |            $-$[viol]|           |                    $-$[viol]|                     $+$[viol]|    $-$[viol]|
| --- mid                   |        $(-)$[viol]|                $-$[viol]|    $(-)$[viol]/$+$|          $(-)$[viol]|           |                             |                     $+$[viol]|             |
| --- upp                   |        $(-)$[viol]|                $+$[viol]|          $+$[viol]|                     |           |              $+$/$(+)$[viol]|                     $-$[viol]|    $+$[viol]|
...
|                           | Conflict      | Confl. Deaths | Civ. Deaths | OSV     | OSV Deaths | LPI     | Killings | NSC       | NSC Deaths | NSC Civ. Deaths | Homicides    |
|:--------------------------|:-------------:|:-------------:|:-----------:|:-------:|:----------:|:-------:|:--------:|:---------:|:----------:|:---------------:|:------------:|
| Life Expectancy           |               |               |          $+$|      $-$|            |      $+$|          |           |            |                 |              |
| Infant Mortality          |            $-$|               |             |    $(-)$|            |    $(-)$|          |           |            |                 |              |
| MYS Ratio                 |               |               |             |         |         $-$|      $-$|          |           |            |                 |              |
...
| upp classification        |               |            $-$|          $-$|         |            |      $+$|          |        $+$|         $-$|                 |              |
| lagged DV                 |            $+$|            $+$|          $+$|      $+$|            |      $+$|       $+$|      $(+)$|         $+$|              $+$|           $+$|
| --- low                   |      $+$[viol]|      $+$[viol]|    $+$[viol]|$+$[viol]|            |$+$[viol]|$+$[viol]~|           |   $+$[viol]|        $+$[viol]|$+$/$-$[viol]~|
| --- H>G                   |            $+$|      $+$[viol]|  $(-)$[viol]|    $(+)$|            |$+$[viol]|$+$[viol]~|  $+$[viol]| $(+)$[viol]|                 |    $+$[viol]~|
| --- G>H                   |$+$/$(+)$[viol]|    $(+)$[viol]|             |         |            |$+$[viol]|$+$[viol]~|           |            |                 |          $+$~|
| --- mid                   |            $+$|      $-$[viol]|             |$+$[viol]|            |$+$[viol]| $+$[viol]|           | $(+)$[viol]|                 |    $+$[viol]~|
| --- upp                   |$+$/$(+)$[viol]|               |             |      $+$|            |$+$[viol]| $+$[viol]|$(+)$[viol]|            |                 |$+$/$-$[viol]~|
