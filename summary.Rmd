...
| **_Base Models_**           | Life Expectancy     | IMR               |
|:----------------------------|:-------------------:|:-----------------:|
| lagged DV                   |                  $+$|                $+$|
| Life Expectancy             |                   DV|                 na|
| Infant Mortality            |                   na|                 DV|
| MYS Ratio                   |                $(+)$|                $+$|
| Adolescent Fertility Rate   |                $(+)$|                $+$|
| low classification          |                     |$-$(mid)/$(-)$(upp)|
| H>G classification          |             $-$(mid)|  $+$(upp)/$-$(mid)|
| G>H classification          |             $+$(upp)|                $+$|
| mid classification          |             $+$(upp)|                $+$|
| upp classification          |             $-$(mid)|$-$(mid)/$(+)$(low)|
|                             |                     |                   |
| **_Internal Conflict_**     | **Life Expectancy** | **IMR**           |
| Conflict                    |                  $+$|                $-$|
| Conflict: low               |                $[+]$|                   |
| Conflict: H>G               |                $[+]$|                $-$|
| Conflict: G>H               |                $[+]$|              $(-)$|
...
| Conflict Civ. Deaths: upp   |                  $-$|                   |
|                             |                     |                   |
| **_One-sided Violence_**    | **Life Expectancy** | **IMR**           |
| OSV                         |                     |              $(-)$|
| OSV: low                    |                  $-$|              $(-)$|
| OSV: H>G                    |                  $+$|                   |
| OSV: G>H                    |                     |                   |
...
| OSV Deaths: upp             |                     |                   |
|                             |                     |                   |
| **_Societal Violence_**     | **Life Expectancy** | **IMR**           |
| NSC                         |                  $-$|                   |
| NSC: low                    |                  $-$|                   |
| NSC: H>G                    |                     |                   |
| NSC: G>H                    |                     |              $(+)$|
...
| Homicides: upp              |                $(-)$|                   |
|                             |                     |                   |
| **_State Repression_**      | **Life Expectancy** | **IMR**           |
| LPI                         |                  $-$|                   |
| LPI: low                    |                  $-$|                $-$|
| LPI: H>G                    |                     |              $(+)$|
| LPI: G>H                    |                     |                   |
...
| Torture: upp                |                     |              $(+)$|
|                             |                     |                   |
| **_Types of Violence_**     | **Life Expectancy** | **IMR**           |
| Conflict Deaths             |                  $-$|                   |
| Conflict Deaths (~hom)      |                     |              $(-)$|
| Conflict Civ. Deaths        |                  $+$|                   |
| Conflict Civ. Deaths (~hom) |                     |                   |
...
|                           |Confl.| War    |Confl. Deaths|Conflict Civ. Deaths| OSV |OSV Deaths| NSC    | NSC Deaths | NSC Civ. Deaths | Homicides | LPI             | Torture | Killings |
|:--------------------------|:----:|:------:|:-----------:|:------------------:|:---:|:--------:|:------:|:----------:|:---------------:|:---------:|----------------:|:-------:|:--------:|
| Life Expectancy           |      |        |             |                 $+$|  $-$|     $[+]$|        |            |                 |           |              $+$|    $(-)$|          |
| Infant Mortality          |   $-$|        |             |                    |$(-)$|          |        |            |                 |           |            $(-)$|         |          |
| MYS Ratio                 |      |     $-$|             |                    |     |       $-$|        |            |                 |           |              $-$|         |          |
| Adolescent Fertility Rate |   $-$|        |             |                    |     |          |        |            |                 |        $+$|            $[+]$|         |     $(+)$|
| low classification        |      |     $+$|          $+$|                    |     |          |     $-$|         $+$|                 |           |         $-$(mid)|         |          |
| H>G classification        |      |$-$(low)|     $-$(low)|                    |     |          |$+$(low)|    $-$(low)|                 |   $+$(mid)|$-$(mid)/$+$(low)|         |          |
| G>H classification        |      |$-$(low)|             |                    |     |          |$+$(low)|    $-$(low)|                 |           |$-$(mid)/$+$(low)|         |          |
| mid classification        |      |$-$(low)|     $-$(low)|                    |     |          |$+$(low)|    $-$(low)|                 |           |         $+$(low)|         |          |
| upp classification        |      |$-$(low)|     $-$(low)|                 $-$|     |          |$+$(low)|    $-$(low)|                 |           |$-$(mid)/$+$(low)|         |          |
| lagged DV                 |   $+$|     $+$|          $+$|                 $+$|  $+$|          |   $(+)$|         $+$|              $+$|        $+$|              $+$|      $+$|       $+$|
| low interaction           | $[+]$|     $+$|          $+$|                 $+$|  $+$|          |        |         $+$|              $+$|      $[+]$|            $[+]$|    $[+]$|     $[+]$|
| H>G interaction           | $[+]$|        |          $+$|               $(-)$|$(+)$|          |     $+$|       $(+)$|                 |      $[+]$|            $[+]$|    $[+]$|     $[+]$|
| G>H interaction           | $[+]$|     $+$|        $(+)$|                    |     |          |        |            |                 |      $[+]$|            $[+]$|    $[+]$|     $[+]$|
