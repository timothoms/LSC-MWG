...
# results$ests$fe$m1$est
# results$ests$fe$m1$info

lapply(results$ests[c("fe", "fegls")], function(toplevel) {
    lapply(toplevel, function(modellevel) {
        names(modellevel)
...
results[["ests"]][["fe"]][["m1"]]
```
```{r int_health_conflict_m2, results = 'hide', fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%"}
...
```
```{r int_health_conflict_m4, results = 'hide', fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%"}
lapply(c("fe", "fegls"), function(estimator) {
...
```
```{r int_health_conflict_m8, results = 'hide', fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%"}
lapply(c("fe", "fegls"), function(estimator) {
...
results$tests
```
```{r int_health_war_m2, results = 'hide', fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%"}
lapply(c("fe", "fegls"), function(estimator) {
  IntPlot(fit = results$ests[[estimator]][["m2"]]$fit, 
          eff_var = c("past Health" = "lag_health"), 
          int_vars = "lag_health:lag_gender", 
...
```
```{r int_health_war_m4, results = 'hide', fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%"}
lapply(c("fe", "fegls"), function(estimator) {
  IntPlot(fit = results$ests[[estimator]][["m4"]]$fit, 
          eff_var = c("past LPI" = "lag_latentmean_fariss"), 
          int_vars = "lag_latentmean_fariss:lag_health", 
...
```
```{r int_health_war_m8, results = 'hide', fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%"}
lapply(c("fe", "fegls"), function(estimator) {
  IntPlot(fit = results$ests[[estimator]][["m8"]]$fit,
          eff_var = c("past Internal War" = "lag_war_internal"),
          ylabel = "Health", xlabel = "past Classification",
...
results$tests
```
```{r int_gender_conflict_m2, results = 'hide', fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%"}
lapply(c("fe", "fegls"), function(estimator) {
  IntPlot(fit = results$ests[[estimator]][["m2"]]$fit, 
          eff_var = c("past Health" = "lag_health"), 
          int_vars = "lag_health:lag_gender", 
...
```
```{r int_gender_conflict_m4, results = 'hide', fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%"}
lapply(c("fe", "fegls"), function(estimator) {
  IntPlot(fit = results$ests[[estimator]][["m4"]]$fit, 
          eff_var = c("past LPI" = "lag_latentmean_fariss"), 
          int_vars = "lag_latentmean_fariss:lag_health", 
...
```
```{r int_gender_conflict_m8, results = 'hide', fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%"}
lapply(c("fe", "fegls"), function(estimator) {
  IntPlot(fit = results$ests[[estimator]][["m8"]]$fit,
          eff_var = c("past Internal Conflict" = "lag_conflict_internal"),
...
results$tests
```
```{r int_gender_war_m2, results = 'hide', fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%"}
lapply(c("fe", "fegls"), function(estimator) {
  IntPlot(fit = results$ests[[estimator]][["m2"]]$fit, 
          eff_var = c("past Health" = "lag_health"), 
          int_vars = "lag_health:lag_gender", 
...
```
```{r int_gender_war_m4, results = 'hide', fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%"}
lapply(c("fe", "fegls"), function(estimator) {
  IntPlot(fit = results$ests[[estimator]][["m4"]]$fit, 
          eff_var = c("past LPI" = "lag_latentmean_fariss"), 
          int_vars = "lag_latentmean_fariss:lag_health", 
...
```
```{r int_gender_war_m8, results = 'hide', fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%"}
lapply(c("fe", "fegls"), function(estimator) {
  IntPlot(fit = results$ests[[estimator]][["m8"]]$fit,
          eff_var = c("past Internal War" = "lag_war_internal"),
          ylabel = "Gender", xlabel = "past Classification",
...
results$tests
```
```{r int_conflict_m2, results = 'hide', fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%"}
lapply(c("fe", "fegls"), function(estimator) {
  IntPlot(fit = results$ests[[estimator]][["m2"]]$fit, 
          eff_var = c("past Health" = "lag_health"), 
          int_vars = "lag_health:lag_gender", 
...
```
```{r int_conflict_m7, results = 'hide', fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%"}
lapply(c("fe", "fegls"), function(estimator) { 
...
results$tests
```
```{r int_war_m2, results = 'hide', fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%"}
lapply(c("fe", "fegls"), function(estimator) {
  IntPlot(fit = results$ests[[estimator]][["m2"]]$fit, 
          eff_var = c("past Health" = "lag_health"), 
          int_vars = "lag_health:lag_gender", 
...
```
```{r int_war_m7, results = 'hide', fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%"}
lapply(c("fe", "fegls"), function(estimator) { 
  IntPlot(fit = results$ests[[estimator]][["m7"]]$fit, 
          eff_var = c("past Internal War" = "lag_war_internal"),
...
results$tests
```
```{r int_lpi_m2, results = 'hide', fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%"}
lapply(c("fe", "fegls"), function(estimator) {
  IntPlot(fit = results$ests[[estimator]][["m2"]]$fit, 
          eff_var = c("past Health" = "lag_health"), 
          int_vars = "lag_health:lag_gender", 
...
```
```{r int_lpi_m7, results = 'hide', fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%"}
lapply(c("fe", "fegls"), function(estimator) {
  IntPlot(fit = results$ests[[estimator]][["m7"]]$fit,
          eff_var = c("past LPI" = "lag_latentmean_fariss"),
