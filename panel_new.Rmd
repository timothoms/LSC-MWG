...
results$tests
```
```{r int_health_conflict, results = 'hide', fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%"}
...
results$tests
```
```{r int_health_conflict_class, results = 'hide', fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%"}
lapply(c("fe", "fegls"), function(estimator) {
...
results$tests
```
```{r int_health_war, results = 'hide', fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%"}
lapply(c("fe", "fegls"), function(estimator) {
  IntPlot(fit = results$ests[[estimator]][["m3"]]$fit, 
          eff_var = c("past Health" = "lag_health"), 
          int_vars = "lag_health:lag_gender", 
...
results$tests
```
```{r int_health_war_class, results = 'hide', fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%"}
lapply(c("fe", "fegls"), function(estimator) {
  IntPlot(fit = results$ests[[estimator]][["m4"]]$fit,
          eff_var = c("past Internal War" = "lag_war_internal"),
          ylabel = "Health", xlabel = "past Classification",
...
results$tests
```
```{r int_gender_conflict, results = 'hide', fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%"}
lapply(c("fe", "fegls"), function(estimator) {
  IntPlot(fit = results$ests[[estimator]][["m3"]]$fit, 
          eff_var = c("past Health" = "lag_health"), 
          int_vars = "lag_health:lag_gender", 
...
results$tests
```
```{r int_gender_conflict_class, results = 'hide', fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%"}
lapply(c("fe", "fegls"), function(estimator) {
  IntPlot(fit = results$ests[[estimator]][["m4"]]$fit,
          eff_var = c("past Internal Conflict" = "lag_conflict_internal"),
...
results$tests
```
```{r int_gender_war, results = 'hide', fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%"}
lapply(c("fe", "fegls"), function(estimator) {
  IntPlot(fit = results$ests[[estimator]][["m3"]]$fit, 
          eff_var = c("past Health" = "lag_health"), 
          int_vars = "lag_health:lag_gender", 
...
results$tests
```
```{r int_gender_war_class, results = 'hide', fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%"}
lapply(c("fe", "fegls"), function(estimator) {
  IntPlot(fit = results$ests[[estimator]][["m4"]]$fit,
          eff_var = c("past Internal War" = "lag_war_internal"),
          ylabel = "Gender", xlabel = "past Classification",
...
```{r int_war, results = 'hide', fig.width = 7, fig.height = 5, out.width = "50%", out.height = "50%"}
lapply(c("fe", "fegls"), function(estimator) {
  IntPlot(fit = results$ests[[estimator]][["m3"]]$fit, 
          eff_var = c("past Health" = "lag_health"), 
          int_vars = "lag_health:lag_gender", 
