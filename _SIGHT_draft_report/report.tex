...
\todo[inline]{expand intro to explain the what and why of this report, note that this was written with others}
...
\todo[inline]{keep this section and make clear this is the previous iteration of the research to build on, and that it was partly co-authored with Dane Rowlands}
...
\todo[inline]{include new link here}

\subsection{Extensions of analyses in this report}

\todo[inline]{Why these Extensions? include language from contract on what and why}

\todo[inline]{FROM Possible extensions}

\todo[inline]{cut but note in introduction that the extensions were in part called for here}
...
\todo[inline]{keep data explanation mostly as is but expand as needed}
...
\todo[inline]{note on internal war and torture analyses not shown and why}

\subsection{Classifications}

\todo[inline]{use the new figures to explain the classifications}
...
\todo[inline]{explain and note what would provide good evidence}

\section{Cross-sectional Analyses}

\todo[inline]{move into intro and appendix as needed}

\subsection{Methods}

\todo[inline]{keep this to explain why the time-line analyses}
...
\todo[inline]{don't include the cross-sectional regression tables and full discussion, just the summary, also note that written by Dane}
...
\todo[inline]{expand this explanation of methods}
...
\todo[inline]{just note briefly the main findings from before, and perhaps include table in appendix for comparison}

Rather than presenting the many detailed regression tables of these analyses, we show summary tables of statistically significant findings (at the 0.05 alpha level).\footnote{The details of individual regressions are provided at \href{oskarthoms.net/lcwg/}{oskarthoms.net/lcwg/panel.html}.}\todo{new URL}
...
\todo[inline]{discuss overall findings with illustrative examples and refer to detailed findings in appendix and on website}
...
\todo[inline]{rewrite this based on new analyses and list questions to address in the final report}
...
\todo[inline]{What has been done and what needs to be figured out?}
...
\todo[inline]{add notes symbols in legend and make separate legend for old summary tables}
