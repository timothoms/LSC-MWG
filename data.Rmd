...
variables_to_include <- c("labor_mod_ratio15_ilo", "mys_ratio_hdr", "mys_age_ratio_ihme", "tfr_wpp", 
                          ...
                          "latentmean_fariss", "deaths_all_nsc_rate", "hom_odcwho_rate", 
                          "conflict_internal", "conflict_non_state", "conflict_one_sided")
...
names(vars) <- vars <- c(variables$health, variables$gender, "mys_ratio_hdr", "pc_rgdpe_pwt")
data <- data %>% 
...
take_logs <- c("pc_rgdpe_pwt", "life_exp_wpp")
