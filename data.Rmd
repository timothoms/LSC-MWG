...
## Averaging key variables and coding performance measures for later use
...
summary(data[, c(take_logs, take_logs_negative)])
...
summary(data[, paste ("lg", c(take_logs, take_logs_negative), sep = "_")])
